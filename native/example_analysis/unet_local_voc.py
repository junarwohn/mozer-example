...
def load_data():
    # change to VOC 2012
    # cap = cv2.VideoCapture(os.environ['TS_DATA_PATH'] + "/VOC_data")
    base_dir = os.environ['TS_DATA_PATH'] + "/VOC_data"
    file_paths = sorted(list(map((base_dir+"/{}").format, os.listdir(base_dir))))
...
if __name__ == '__main__':
    ...
    print("------------------------")
    np.save("./local.npy", np.array(output_log))